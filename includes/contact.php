...
if ($response != null && $response->success)
    ...
    <div class="contact-feedback">
        <h3 class="feedback">Your Comments Have Been Received!</h3>
        <h3 class="feedback">Thanks for the input!</h3>
    </div>    
    <!-- END HTML FEEDBACK -->        
    <?php
...
?>
	...
	<div>
		<label>
			Name:<br /><input class="form-field" type="text" name="Name" required="required" placeholder="Full Name (required)" title="Name is required" tabindex="10" size="38" autofocus />
		</label>
	</div>
	<div>	
		<label>
	...
	<div>	
		<label>
			Comments:<br /><textarea class="form-field" name="Comments" cols="36" rows="4" placeholder="Your comments are important to us!" tabindex="30"></textarea>
		</label>
	</div>	
	<div><?=$feedback?></div>
